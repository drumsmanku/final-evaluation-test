...
function LoginPopUp({ closeModal, showLoginModal }) {
  ...
  return (
    <div className="login-popup-container">
      <header className="login-popup-header">
        ...
        {showLoginModal && (
          <div className="modal-login" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh' }}>
            <div className="modal-login-content">
              
              <div className="modal-login-body">
              <span className="close" onClick={closeModal}> {/* Close Modal onClick */}
                &times;
              </span>
              ...
              <h2>Log in to continue</h2>
                ...
                <div style={{width:'85%'}}>
                  <button className='signup-button' type="submit" style={{ cursor:'pointer'}} onClick={login}>Log In</button>
                </div>
