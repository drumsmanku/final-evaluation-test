          ...
          <div className="product-cards">
            {
              sortedProducts.map((product, key)=>(
                <div className='main-card-container-div' style={{display:'flex', flexDirection:'column', backgroundColor:'#36416A26',marginBottom:'1rem',borderRadius:'0.5rem', padding:'1rem 1rem 0 1rem'}}>
