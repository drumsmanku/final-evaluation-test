    ...
    <div className='main-container'>
      ...
      <div className="main-bottom-container">
        ...
        <div className="bottom-right">
          ...
          {showLoginModal && <LoginPopUp closeModal={() => setShowLoginModal(false)} showLoginModal={showLoginModal} />}
          {showSignupModal && <SignupPopUp closeModal={() => setShowSignupModal(false)} showSignupModal={showSignupModal} />}
          {isLoggedIn? (showAddModal && <AddProductPopUp closeModal={() => setShowAddModal(false)} showAddModal={showAddModal} />):(showSignupModal && <SignupPopUp closeModal={() => setShowSignupModal(false)} showSignupModal={showSignupModal} />)}
                  ...
                  <div style={{display:'flex', justifyContent:'space-between', width:"90%"}}>
                    <div className="card-main-info">
                      ...
                      <div style={{display:'flex', width:'40%', justifyContent:'space-between'}}>
                        ...
                        <button className='comments-button'> <img style={{marginRight:'0.3rem'}} src={comments} alt="" height={25} />Comment</button>
                      </div>
                    </div>
