    ...
    <div className='main-container'>
      ...
      <div className="main-bottom-container">
        <div className="bottom-left">
          <article style={{backgroundColor:'#36416A', width:'60%', color:'white', paddingLeft:'0.7rem'}}>
            <h2 style={{marginBottom:'0.4rem'}}>Feedback</h2>
            <h5 style={{marginTop:0}}>Apply Filter</h5>
          </article>
        </div>
