...
function MainPage() {
  ...
  const [commentsLength, setCommensLength]=useState(null)
  useEffect(()=>{
  ...
  const handleCommentsLengthChange=(length)=>{
    setCommensLength(length);
  }
  const handleLogin = () => {
          ...
          <div className="product-cards">
            {
              products.map((product, key)=>(
                <div style={{display:'flex', flexDirection:'column', backgroundColor:'#36416A26',marginBottom:'1rem',borderRadius:'0.5rem', padding:'0 1rem 0 1rem'}}>
                    ...
                    <div style={{display:'flex', justifyContent:'space-between', width:"90%"}}>
                      ...
                      <div className="upvotes">
                        <div className="upvote-container">
                          <button style={{background:'none', outline:'none', border:'none', cursor:'pointer'}}><img style={{}} src={upvote} alt="" /></button>
                        </div>
                  ...
                  {commentProductId === product._id && <CommentsSection setCommentsLength={handleCommentsLengthChange} productId={product._id} />}
                </div>
