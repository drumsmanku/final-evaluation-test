    ...
    <div className='main-container'>
      <div className="main-top-container">
        ...
        <div className="title-desc">
          ...
          <div className='both-headings' style={{display:'flex', flexDirection:'column', marginLeft:'2rem'}}>
          ...
          <div className='bottom-top-right'>
            <div style={{display:'flex', width:'30%', justifyContent:'space-between',marginLeft:'1rem'}}>
              ...
              <span>
                ...
                <select style={{border:'none', outline:'none', fontFamily:'DM Sans', fontSize:'medium', fontWeight:'bold'}} value={sortOption} onChange={(e) => setSortOption(e.target.value)}>
          ...
          <div className="product-cards">
            {
              sortedProducts.map((product, key)=>(
                <div style={{display:'flex', flexDirection:'column', backgroundColor:'#36416A26',marginBottom:'1rem',borderRadius:'0.5rem', padding:'0 1rem 0 1rem'}}>
                  <div style={{...productCardsStyles}}>
                    ...
                    <div style={{display:'flex', justifyContent:'space-between', width:"90%"}}>
                      ...
                      <div className="upvotes">
                        ...
                        <div style={{height:'50%', display:'flex', alignItems:"center", width:'230%'}}>
                          {isLoggedIn && (<button className='edit-popup-button' type="submit" style={{ cursor:'pointer'}} >Edit</button>)}
