    ...
    <div className='main-container'>
      ...
      <div className="main-bottom-container">
        <div className="bottom-left">
          <article style={{backgroundColor:'#36416A', width:'65%', color:'white', paddingTop:'2rem', borderRadius:'0.8rem', marginBottom:'2rem'}}>
            <h2 style={{marginBottom:'0.4rem',marginLeft:'1rem'}}>Feedback</h2>
            <h5 style={{marginTop:0, marginLeft:'1rem'}}>Apply Filter</h5>
          </article>
          <article style={{width:'65%', borderRadius:'0.8rem', padding:'1rem', boxShadow:'0 0 17px #00000026', textAlign:'center'}}>
