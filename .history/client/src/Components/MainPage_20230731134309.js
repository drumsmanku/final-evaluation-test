...
function MainPage() {
  ...
  const updateCommentCount = (count) => setCommentsLength(count);
  const handleLogin = () => {
          ...
          <div className="product-cards">
            {
              products.map((product, key)=>(
                <div style={{display:'flex', flexDirection:'column', backgroundColor:'#36416A26',marginBottom:'1rem',borderRadius:'0.5rem', padding:'0 1rem 0 1rem'}}>
                  ...
                  {commentProductId === product._id && <CommentsSection productId={product._id}  updateCommentCount={updateCommentCount} />}
                </div>
