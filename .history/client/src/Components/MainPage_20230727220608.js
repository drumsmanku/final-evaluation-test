    ...
    <div className='main-container'>
      <div className="main-top-container">
        ...
        <div className="title-desc">
          <img src={img1} alt="" height={500} style={{marginLeft:'2rem'}}/>
          <div style={{display:'flex', flexDirection:'column', }}>
              <h1 style={{maxWidth:'80%'}}> Add your products and give your valuable feedback</h1>
              <span style={{maxWidth:'80%', color:'#6A6A6A'}}>Easily give your feedback in a matter of minutes. Access your audience on all platforms. Observe result manually in real time</span>
          </div>
        </div>
      </div>
