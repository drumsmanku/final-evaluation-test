              ...
              sortedProducts.map((product, key)=>(
                <div className='main-card-container-div' style={{display:'flex', flexDirection:'column', backgroundColor:'#36416A26',marginBottom:'1rem',borderRadius:'0.5rem', padding:'0.5rem 1rem 0 1rem'}}>
                  <div style={{...productCardsStyles}}>
                    <div className='logo' style={{width:'10%', }}> <img src={product.logoURL} alt="image" height={70} /> </div>
                    <div style={{display:'flex', justifyContent:'space-between', width:"90%"}}>
                      ...
                      <div className="upvotes">
                        ...
                        <div className='comments-and-edit' style={{height:'50%', display:'flex', alignItems:"center", width:'230%'}}>
                          {isLoggedIn && (<button className='edit-popup-button' type="submit" style={{ cursor:'pointer', marginBottom:'1rem'}} onClick={()=>{setEditProductId(product._id); setShowEditModal(true)}} >Edit</button>)}
