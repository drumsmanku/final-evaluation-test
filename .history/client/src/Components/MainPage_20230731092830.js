          ...
          <div className="product-cards">
            {
              products.map((product, key)=>(
                <div style={{display:'flex', flexDirection:'column'}}>
                    ...
                    <div style={{display:'flex', justifyContent:'space-between', width:"90%"}}>
                      <div className="card-main-info">
                        ...
                        <div style={{display:'flex', width:'40%', justifyContent:'space-between'}}>
                          ...
                          <button className='comments-button' onClick={() => {handleShowComments(product._id); setIsVisible(!isVisible)}} > <img style={{marginRight:'0.3rem'}} src={comments} alt="" height={25}  />Comment</button>
                        </div>
                      </div>
                  ...
                  {commentProductId === product._id && isVisible&& <CommentsSection productId={product._id} />}
                </div>
