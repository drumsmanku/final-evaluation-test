          ...
          <div className="product-cards">
            {
              products.map((product, key)=>(
                <div style={{display:'flex', flexDirection:'column'}}>
                    ...
                    <div style={{display:'flex', justifyContent:'space-between', width:"90%"}}>
                      <div className="card-main-info">
                        ...
                        <div style={{display:'flex', width:'40%', justifyContent:'space-between'}}>
                          ...
                          <button className='comments-button'> <img style={{marginRight:'0.3rem'}} src={comments} alt="" height={25} onClick={() => setIsVisible(true)} />Comment</button>
                        </div>
                      </div>
                  ...
                  <CommentsSection productId={product._id} setIsVisible={setIsVisible} isVisible={isVisible} />
                </div>
