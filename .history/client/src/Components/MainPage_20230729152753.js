              ...
              products.map((product, key)=>(
                <div style={{...productCardsStyles}}>
                  ...
                  <div className="card-main-info">
                    <h1 style={{marginTop:0, marginBottom:'0.5rem', color:'#36416A'}}>{product.companyName}</h1>
                    ...
                    <div style={{display:'flex', width:'50%', justifyContent:'space-between'}}>
                      ...
                      <button className='comments-button'> <img style={{marginRight:'0.3rem'}} src={comments} alt="" height={25} />Comments</button>
                    </div>
                  </div>
                </div>
              ))
