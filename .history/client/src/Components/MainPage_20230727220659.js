      ...
      <div className="main-top-container">
        ...
        <div className="title-desc">
          ...
          <div style={{display:'flex', flexDirection:'column', marginLeft:'2rem'}}>
              ...
              <span style={{maxWidth:'70%', color:'#6A6A6A'}}>Easily give your feedback in a matter of minutes. Access your audience on all platforms. Observe result manually in real time</span>
          </div>
        </div>
      </div>
