    ...
    <div className='main-container'>
      ...
      <div className="main-bottom-container">
        <div className="bottom-left">
          <article style={{backgroundColor:'#36416A', width:'65%', color:'white', paddingTop:'2rem', borderRadius:'0.8rem'}}>
            <h2 style={{marginBottom:'0.4rem',marginLeft:'1rem'}}>Feedback</h2>
            <h5 style={{marginTop:0, marginLeft:'1rem'}}>Apply Filter</h5>
          </article>
          <article style={{width:'65%', borderRadius:'0.8rem', padding:'1rem'}}>
             {buttonTitles.map((title, idx)=>(
              <button onClick={handleCategoryClick} style={{...buttonStyles}} key={idx}>{title}</button>
             ))}
          </article>
        </div>
