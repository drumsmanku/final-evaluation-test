        ...
        <div className='navbar' >
          ...
          <div style={{display:'flex', marginRight:'5rem'}}>
              {isLoggedIn ? (
                ...
                <>
                  <button className='btn-main-page-login' type='submit' onClick={()=> setShowLoginModal(true)} >Log in</button>
                  <button type='submit'  className='btn-main-page-register' onClick={()=>setShowSignupModal(true)} >Sign up</button>
                </>
              )}
              {showModal && < LoginPopUp showModal={showModal} />}
              {showSignupModal && < SignupPopUp showModal={showSignupModal} />}
            </div>
          </div>
        </div>
