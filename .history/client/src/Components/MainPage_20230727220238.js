      ...
      <div className="main-top-container">
        ...
        <div className="title-desc">
          ...
          <div style={{display:'flex', flexDirection:'column', }}>
              ...
              <span style={{maxWidth:'80%'}}>Easily give your feedback in a matter of minutes. Access your audience on all platforms. Observe result manually in real time</span>
          </div>
        </div>
      </div>
