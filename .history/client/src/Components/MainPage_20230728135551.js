    ...
    <div className='main-container'>
      ...
      <div className="main-bottom-container">
        <div className="bottom-left">
          <article style={{backgroundColor:'#36416A', width:'60%', color:'white',}}>
            <h2 style={{marginBottom:'0.4rem', marginLeft:'0.8rem'}}>Feedback</h2>
            <h5 style={{marginTop:0,  marginLeft:'0.8rem'}}>Apply Filter</h5>
          </article>
        </div>
