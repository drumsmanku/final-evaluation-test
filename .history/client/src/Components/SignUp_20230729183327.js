  ...
  return (
    <div className='signup-container'>
      ...
      <form>
        ...
        <span style={{}}>Already have an account? <button style={{background:'none', color:'#737373', fontSize:'medium', marginLeft:0, padding:0, width:'5rem', cursor:'pointer'}} onClick={()=>{navigate('/login')}}>Log In</button></span>
