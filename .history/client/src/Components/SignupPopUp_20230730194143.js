...
function SignupPopUp({closeModal, showSignupModal, setShowLoginModal, setShowSignupModal}) {
          ...
          <div className="modal-signup" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh' }} onClick={handleClickOutside}> 
            <div className="modal-content" onClick={handleClickInside}> 
              ...
              <h2>Signup to continue</h2>
                ...
                <span style={{color:'#737373'}}>Already have an account?<button style={{background:'none', color:'#36416A', fontSize:'medium', marginLeft:0, padding:0, width:'4rem', cursor:'pointer', border:'none', textDecoration:'underline'}} onClick={() =>{setShowLoginModal(true); setShowSignupModal(false)} }>Log In</button></span>
